...
- 从“几何/分布”角度：`z -> x` 是一个潜变量到数据空间的映射（可视作参数化/推前分布）。见 [modules/probabilistic/LatentToDataMapping.md](LatentToDataMapping.md)

相关页：
- ELBO：[modules/probabilistic/ELBO.md](ELBO.md)

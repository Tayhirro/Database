...
不同方法的区别不在于问题本身，而在于**怎么实例化和求解**这个问题。可以沿 5 个轴来拆解：
...
**① 扰动空间**：你改的"东西"是什么。大多数方法在像素空间加噪声，但也可以在颜色参数空间、仿射变换参数空间、GAN 的潜空间、甚至离散的词表空间里做扰动。扰动空间决定了梯度对谁求导。
...
| 学习到的优化（L2L） | 网络学的更新规则，仍然迭代 | Learned Optimizer (RNN/Transformer) |
...
| 计算时机 | 含义 | 代表 |
|----------|------|------|
| 在线逐样本 | 每来一个新样本，当场做优化/搜索 | PGD, L2L, Square Attack |
...
| **L2L** | 像素 | $L_p$ 球 | 梯度（白盒） | **网络学的**：RNN/Transformer 决定更新 | 在线多步 |
